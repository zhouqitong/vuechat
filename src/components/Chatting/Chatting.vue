    ...
    <div class="chatting">
      ...
      <div class="chatting-header">
        ...
        <div class="chatting-title">
          <h2><i class="icon-group"></i>Group chat</h2>
        </div>
      ...
      <div class="chatting-input">
        ...
        <textarea @keyup.enter="send" @input="newLine" ref="textarea" v-model.trim="inputContent" placeholder="回车键完成输入"></textarea>
...
export default {
  ...
  mounted() {
    ...
    console.log("height"+this.oContent.scrollTop);
